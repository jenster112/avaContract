...
contract UpdateScript is Script {
    ...
    function run() public {
        ...
        pairInfos = PairInfos(0xab3AFb807b623195CC43433f44f07a5051F9519E);
        _display();
    ...
    function _display() internal view {
        ...
        (IPairStorage.Pair memory btcPair,,)  =  pairStorage.pairsBackend(0);
        (IPairStorage.Pair memory ethPair ,,) =  pairStorage.pairsBackend(1);
        (IPairStorage.Pair memory jpyPair,,)  =  pairStorage.pairsBackend(2);
        console.logUint(btcPair.groupIndex);
        console.logUint(ethPair.groupIndex);
        console.logUint(jpyPair.groupIndex);
    }
}